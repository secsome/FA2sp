...
void SHA1Impl::add(const void* data, size_t numBytes)
{
...
void SHA1Impl::getHash(unsigned char buffer[SHA1Impl::HashBytes])
{
...
std::string SHA1Impl::operator()(const void* data, size_t numBytes)
{
    reset();
    add(data, numBytes);
    return getHash();
...
std::string SHA1Impl::operator()(const std::string& text)
{
    reset();
