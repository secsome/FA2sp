...
constexpr char* PRODUCT_STR = "1.1.0";
constexpr char* DISPLAY_STR = PRODUCT_STR;
constexpr char* VERSION_STRVER = "FA2sp 1.1.0";

constexpr char* PRODUCT_NAME = "FA2sp";
constexpr char* APPLY_INFO = "Found Final Alert 2 version 1.02. Applying FA2sp 1.1.0.";
